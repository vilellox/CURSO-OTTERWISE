/* 12-[REFATORAÇÃO]O dono de uma livraria resolveuque precisava de novasfuncionalidades no seu 
sistema de livros e para isso ele contratou umprogramador. Conversando com o programador e 
entendendo as necessidadesque o dono da livraria precisava, eles chegaram nas seguintes funcionalidades:
...
●Pesquisa pelo nome do livro;●Pesquisa pelo autor do livro;
●Pesquisa pelo código do livro;●Lista do Estoque;
    ...
    function lessSearchPrice(array, price) {
        for (let i = 0; i < array.length; i++) {
          if (array[i].valor < price) {
            ...
            console.log('Desculpe não encontramos nenhum livro com o valor desejado!')
            break
          }
        }
      }
